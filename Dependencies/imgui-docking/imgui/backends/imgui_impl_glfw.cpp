...
{
    Callback::updateMouseButtonCallback(window, button, action, mods);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
...
{
    Callback::updateScrollWheelCallback(window, xoffset, yoffset);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
...
{
    Callback::updateKeyboardCallback(window, keycode, scancode, action, mods);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
...
{
    Callback::windowMousePositionEvent(window, x, y);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
